...
export function SkillCard({ name, Icon }: SkillCardProps) {
  return (
    <div data-testid="skill-card" className="flex flex-col items-center justify-center w-32 h-32 p-4 bg-[var(--color-bg-secondary)] rounded-lg shadow-md transition-transform transform hover:scale-105">
