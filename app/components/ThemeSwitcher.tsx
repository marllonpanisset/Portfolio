...
export function ThemeSwitcher() {
  ...
  // Avoids a hydration mismatch issue with Next.js and next-themes
  if (!mounted) {
    return null;
  }

  // Define os SVGs diretamente como componentes ou strings
  const sunSvg = (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="#0C0C1F"
      stroke="#ffffff" // stroke e fill definidos aqui
    >
  ...
  const moonSvg = (
    <svg
      ...
      height="24"
      viewBox="0 0 24 24"
      fill="#ffffff" // stroke e fill definidos aqui
      stroke="#ffffff"
    >
  ...
  return (
    ...
    >
      {/* Exibe o SVG da lua se o tema for 'dark', senão, exibe o do sol. */}
